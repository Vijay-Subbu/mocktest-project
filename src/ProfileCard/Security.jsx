  ...
  return (
    <div class="container-xl px-4 mt-4">
      <nav class="nav nav-borders">
        <a class="nav-link  ms-0" href="/home/profile" target="">
          Profile
        </a>
        <a class="nav-link active" href="/home/profile/security" target="">
          Security
        </a>
      </nav>
      <hr class="mt-0 mb-4" />
              ...
              <form>
                <div class="form-check">
                  <input
                    ...
                    checked=""
                  />
                  <label class="form-check-label" for="twoFactorOn">
                    On
                  </label>
                </div>
                <div class="form-check">
                  <input
                    ...
                    name="twoFactor"
                  />
                  <label class="form-check-label" for="twoFactorOff">
                    Off
                  </label>
                </div>
                <div class="mt-3">
                  <label class="small mb-1" for="twoFactorSMS">
                    SMS Number
                  </label>
                  <input
                    class="form-control"
